...
function ProjectGridComponent(props) {
        ...
        <div className="project-grid-ah">
            <Link to={"/project-details/" + props.id} className="link-ah">
                <div className="card-body">
                    ...
                    <div>
                        <div className="project-grid-timer-ah" style={{ display: props.currentDisplay }}>
                            <span className="flex">
                        ...
                        <div className="project-grid-timer-ah" style={{ display: props.submitDisplay }}>
                            <span className="flex">
                                <h6 style={{ color: statusColor }}>submitted date:</h6>
                                <p>{props.sumbit}</p>
                            </span>
                            <h4 style={{ color: statusColor }}>submitted awaiting approval.............</h4>
                        </div>

                        <div className="project-grid-timer-ah" style={{ display: props.approveDisplay }}>
                            <span className="flex">
                                <h6 style={{ color: statusColor }}>submitted date:</h6>
                                <p>{props.approve}</p>
                            </span>
                            <h4 style={{ color: statusColor }}>project approved</h4>
                        </div>

                        <div className="project-grid-timer-ah" style={{ display: props.expiredDisplay }}>
                            <span className="flex">
                                <h6 style={{ color: statusColor }}>expected date:</h6>
                                <p>Mar 28, 2023</p>
                            </span>
                            <h4 style={{ color: statusColor }}>project expired</h4>
                        </div>
            ...
            <div className="card-body">
                <div className="project-grid-content">
                    ...
                    <span className="flex-btw-ah">
                        <Paperclip width="16px" height="16px" style={{ cursor: "pointer" }} onClick={openResource} />
